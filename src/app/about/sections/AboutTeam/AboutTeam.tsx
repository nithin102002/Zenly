...
const TeamMember = ({ name, role, image }) => (
    <div className="flex flex-col items-center w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
        <div className="relative group w-full h-[300px] md:h-[350px] lg:h-[450px] rounded-lg overflow-hidden"> {/* Increased lg height */}
            <Image 
                src={image}
                alt={name} 
...
const SocialMediaIcon = ({ platform }) => {
    const icons = {
        facebook: (
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor"> {/* Increased size */}
