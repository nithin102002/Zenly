  ...
  return (
    <div className='h-auto w-full bg-white p-4 sm:p-8'> {/* Changed background to white */}
      <div className='flex items-center justify-center'>
        <h1 className='text-black font-teko  tracking-wide text-lg sm:text-xl md:text-3xl lg:text-4xl pt-4 sm:pt-6 text-center font-semibold'>
      ...
      <div className='flex flex-col sm:flex-row items-center justify-around h-auto w-full mt-6 sm:mt-10'>
        <div className='text-black text-sm sm:text-base md:text-lg lg:text-xl mb-4 sm:mb-0'>
          <div className="font-bold mb-2">
            <img src="/assets/Submark.svg" alt="Submark Logo" className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28" />
          </div>
        </div>

        <div className='text-black text-xs sm:text-sm md:text-base lg:text-lg mb-4 sm:mb-0'>
          <div className="mb-2 text-center font-rubik sm:text-left">
            New Gandhi Market,<br /> Oddanchatram,<br /> Dindigul,<br /> Tamilnadu- 624612, India
          </div>
        </div>

        <div className='text-black font-rubik text-xs sm:text-sm md:text-base lg:text-lg mb-4 sm:mb-0'>
          ...
          <div className='flex flex-col items-center sm:items-start mt-4'>
            <a href="https://www.facebook.com/profile.php?id=61566992799583" className='flex items-center mb-2 hover:text-blue-500 transition duration-300' target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mr-2 fill-current text-black" viewBox="0 0 24 24">
            ...
            <a href="https://www.instagram.com/_zenly_apparels?igsh=MXB2ZHUxNG81anc1Nw==" className='flex items-center hover:text-pink-500 transition duration-300' target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mr-2 fill-current text-black" viewBox="0 0 24 24">
