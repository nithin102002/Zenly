...
const Section1: React.FC = () => {
  ...
  return (
    <div className="relative h-[90vh] w-full flex flex-col items-center justify-center px-8 sm:px-4 lg:px-20 overflow-hidden">
      ...
      <h1 className="text-5xl font-teko tracking-wide sm:text-5xl lg:text-8xl xl:text-8xl font-bold mb-4 text-black z-10 fade-in">
        A world of Quality and
      </h1>
      <h1 className="text-5xl font-teko tracking-wide sm:text-5xl lg:text-8xl xl:text-8xl font-bold mb-6 text-black z-10 fade-in">
        Endless Designs
      </h1>
