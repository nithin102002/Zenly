...
const HomeSectionLeft = () => {
  return (
    <div className="flex flex-col justify-start md:w-1/2 p-6 md:p-8 lg:p-10 gap-8">
      ...
      <div className="mt-4">
        <p className="text-xs sm:text-sm uppercase font-semibold text-gray-600 mb-1">Customer Support Satisfaction</p> 
        <div className="w-full bg-gray-300 h-2 rounded-full">
          <div className="w-[99%] bg-orange-500 h-full rounded-full"></div>
        </div>
        <p className="text-right text-xs sm:text-sm mt-1 font-medium text-gray-700">99%</p> 
      </div>
    </div>
  );
}
