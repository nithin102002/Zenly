...
const SocialMediaIcon: React.FC<SocialMediaIconProps> = ({ platform }) => {
    ...
    return (
        <a
            href="#"
            className="p-2 rounded-full bg-white hover:bg-blue-400 hover:text-white transition-all duration-300 flex justify-center items-center"
        >
            {icons[platform]}
        </a>
    );
