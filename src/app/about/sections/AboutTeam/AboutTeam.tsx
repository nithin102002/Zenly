...
//     return (
//         <section className="text-center py-10 bg-gray-100 lg:py-12">
//             <h2 className="text-4xl font-teko  tracking-wide font-bold mb-6 lg:mb-8">Meet the Team</h2>
//             <div className="flex flex-wrap justify-center gap-6 md:gap-8 w-11/12 mx-auto">
//                 <TeamMember name="Ragul" role="CEO" image={person1} />
...
//     <div className="flex flex-col font-teko  tracking-wide items-center w-full sm:w-1/2 md:w-1/3 lg:w-1/4 mb-4">
...
//                 objectFit="contain"
//             />
//             <div className="absolute bottom-[-60px] flex justify-center gap-4 left-0 right-0 group-hover:bottom-2 lg:group-hover:bottom-8 transition-all duration-300">
//                 <SocialMediaIcon platform="facebook" />
//                 <SocialMediaIcon platform="twitter" />
//                 <SocialMediaIcon platform="instagram" />
//             </div>
//         </div>
//         <h3 className="mt-2 font-semibold text-lg lg:text-xl">{name}</h3>
...
//       <h2 className="text-3xl font-teko tracking-wide sm:text-4xl md:text-5xl font-bold text-center text-gray-800 mb-6 md:mb-8">
//         Meet Our Team
//       </h2>
...
//             <div className="min-w-[140px] sm:min-w-[160px] md:min-w-[180px] lg:min-w-[220px] xl:min-w-[240px] h-[260px] flex-shrink-0 relative bg-white rounded-lg shadow-lg transform transition-all duration-300 hover:scale-105">
...
import person2 from '../../../../../public/assets/person2.jpg';
import person3 from '../../../../../public/assets/person3.jpg';
import person4 from '../../../../../public/assets/person3.jpg';
import person5 from '../../../../../public/assets/person3.jpg';
...
const teamMembers = [
  { name: "Ragul", role: "CEO", image: person1 },
  { name: "Jane Smith", role: "Developer", image: person2 },
  { name: "Alex Johnson", role: "Marketing", image: person3 },
  { name: "Aravind", role: "Marketing", image: person4 },
  { name: "Johnson", role: "Marketing", image: person5 }
];

const AboutTeam: React.FC = () => {
  return (
    <section className="text-center py-10 bg-gray-100 lg:py-12 relative">
      <h2 className="text-4xl font-teko tracking-wide font-bold mb-6 lg:mb-8">Meet the Team</h2>
...
const TeamMember: React.FC<TeamMemberProps> = ({ name, role, image }) => (
  <div className="flex flex-col font-teko tracking-wide items-center w-full mb-4">
    <div className="relative group w-full h-[300px] md:h-[350px] lg:h-[450px] rounded-lg overflow-hidden">
      <Image
        src={image}
        alt={name}
    ...
    <h3 className="mt-2 font-medium text-2xl lg:text-4xl">{name}</h3>
    <p className="text-gray-500 text-2xl">{role}</p>
  </div>
);
